namespace SpaceShooter
{
    public class DeathScreen : GameScreen
    {
        ...
        public DeathScreen(Game1 game, int wave) : base(game)
        {
            _wave = wave;
        ...
        public override void Initialize()
        {
            ...
            _restartButton = new Button("Restart", new XnaRectangle((Game.GraphicsDevice.Viewport.Width - 200) / 2, 250, 200, 50));
            _exitButton = new Button("Exit", new XnaRectangle((Game.GraphicsDevice.Viewport.Width - 200) / 2, 350, 200, 50));
        }
